...
<body>
  <div class="wrapper">
    ...
    <nav>
      <a href="/roadworks/index/drupal_prestashop/drupal_prestashop" class="btn prev">
        &larr; Previous Project
      </a>
      <a href="/roadworks/index/drupal_prestashop/project2" class="btn next">
        Next Project &rarr;
      </a>
    ...
    <div class="exercice">
      <header>
          By Epitech-Coding.Academy: drupal / prestashop.
      </header>
      <section>
        <p>
          <h1>Lorem</h1>
