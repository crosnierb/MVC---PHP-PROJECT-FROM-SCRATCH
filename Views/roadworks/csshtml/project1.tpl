...
<body>
  <div class="wrapper">
    ...
    <nav>
      <a href="/roadworks/index/csshtml/csshtml" class="btn prev">
        &larr; Previous Project
      </a>
      <a href="/roadworks/index/csshtml/project2" class="btn next">
        Next Project &rarr;
      </a>

      <div id="num">
        <div><a id="link" href="/roadworks/index/csshtml/csshtml">sommaire</a></div>
    ...
    <div class="exercice">
      <header>
          By Epitech-Coding.Academy: csshtml.
      </header>
      <section>
        <p>
          <h1>Lorem</h1>
