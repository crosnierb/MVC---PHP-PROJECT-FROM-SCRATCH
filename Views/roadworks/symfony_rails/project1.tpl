  ...
  <body>
    <div class="wrapper">
      ...
      <nav>
        <a href="/roadworks/index/symfony_rails/symfony_rails" class="btn prev">
          &larr; Previous Project
        </a>
        <a href="/roadworks/index/symfony_rails/project2" class="btn next">
          Next Project &rarr;
        </a>
      ...
      <div class="exercice">
        <header>
            By Epitech-Coding.Academy: symfony / Rails.
        </header>
        <section>
          <p>
            <h1>Lorem</h1>
