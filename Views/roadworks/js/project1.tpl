                 ...
                 <div class="wrapper">
                   <div class="nav">
                     <ul>
                       ...
                       <li><a class="active" href="/roadworks/index/js/js_native">JS-Native</a></li>
                   ...
                   <nav>
                     <a href="/roadworks/index/js/js_native" class="btn prev">
                       &larr; Previous Project
                     </a>
                     <a href="/roadworks/index/js/project2" class="btn next">
                       Next Project &rarr;
                     </a>

                     <div id="num">
                       <div><a id="link" href="/roadworks/index/js/js_native">sommaire</a></div>
                       <a id="link" href="/roadworks/index/js/project1">1</a>-
                       <a id="link" href="/roadworks/index/js/project2">2</a>
                     </div>
                   </nav>
                   <div class="exercice">
                     <header>
                         By Epitech-Coding.Academy: js_native.
                     </header>
                     <section>
                       <p>
                         <h1>Lorem</h1>
