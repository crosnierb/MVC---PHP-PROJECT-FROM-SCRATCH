...
<head>
  <meta charset="UTF-8">
  <title>crosnierb - Php Sommaire</title>
...
<body>
  <div class="wrapper">
    ...
    <nav>
      ...
      <a href="/roadworks/index/php/project1" class="btn next">
        Next Project &rarr;
      </a>
      <div id="num">
        ...
        <details open>
         ...
         <table>
            ...
            <tr id="linepair">
               <td>lorem</td>
               <td>lorem ipsum</td>
               <td><a id="" href="/roadworks/index/php/project1">Voir >></a></td>
            </tr>
            <tr id="lineimpair">
               <td>lorem</td>
               <td>lorem ipsum</td>
               <td><a id="" href="/roadworks/index/php/project2">Voir >></a></td>
            </tr>
         </table>
      </details>
        </article>
