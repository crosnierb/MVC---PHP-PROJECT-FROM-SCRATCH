  ...
  <main>
    <section>
      <article>
        ...
        <?php
        if (isset($_POST)) {
          $foo = new CategoryController($_POST['name'], $_POST['parent_id'], $_POST['id']);
          $bar = $foo->editingCategory();
        }

        if ($bar != "Category edited\n"){
          if (is_string($bar)){
            echo $bar;
          }
          else {
        ...
        print_r("<article><p>Category edited</p></article>");
